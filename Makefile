...
all:
	@$(CC) $(CFLAGS) main.cpp ./frontend/InputProcessing.cpp ./frontend/Tree.cpp ./frontend/RecursiveDescent.cpp ./graphviz/GraphvizFunctions.cpp ./backend/backend.cpp -o $(TARGET)
